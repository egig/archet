...
/**
 * `instanceof PipelineError` fails when the thrower and this check load `ratchet` as two separate
 * module instances (e.g. a generated file importing the bare `ratchet/*` specifier resolves to a
