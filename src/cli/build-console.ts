...
export async function buildServerBundle(cwd: string, dirs: Dirs): Promise<void> {
  ...
  // — only when opted into (`ratchet generate` wrote `.ratchet/app-routes.server.ts`).
  ...
  const entrySrc = [
    ...
    `import { App, serveNode, createApiRouter, buildRegistryMap, buildDomainSettingsRegistryMap } from '@egig/ratchet/router';`,
