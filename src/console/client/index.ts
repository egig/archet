...
// is the props shape it receives, and the rest are what the generated form itself uses to fetch
// the row, save it, and render the same field editors — reused here rather than making a custom
// form reinvent them.
export type { ModelFormProps, ModelFormComponent } from './custom-forms.js';
