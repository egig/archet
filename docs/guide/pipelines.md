...
A model isn't limited to these three operations — see [Custom Operations](/guide/custom-operations) for defining a named, convenient action (e.g. `lock`/`unlock`) built out of the same pipeline primitives.
